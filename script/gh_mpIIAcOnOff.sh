...
date   > /mnt/wd2tb/script/mpIIaconoff/log/mpIIaconoff_shlog.txt
echo 'Starte mpIIaconoff.sh '  >> /mnt/wd2tb/script/mpIIaconoff/log/mpIIaconoff_shlog.txt


# Einen neuen Agent starten:
eval "$(ssh-agent -s)" >> /mnt/wd2tb/script/mpIIaconoff/log/mpIIaconoff_shlog.txt

# Den ssh-Schluessel hinterlegen:
/usr/bin/ssh-add ~/.ssh/k4  >> /mnt/wd2tb/script/mpIIaconoff/log/mpIIaconoff_shlog.txt

# ssh-Variabelen ins Log schreiben:
env | grep SSH  >>/mnt/wd2tb/script/mpIIaconoff/log/mpIIaconoff_shlog.txt
...
/usr/bin/python /mnt/wd2tb/script/mpIIaconoff/mpIIAcOnOff.py >> /mnt/wd2tb/script/mpIIaconoff/log/mpIIaconoff_shlog.txt

# Den Agenten wieder beenden:
eval "$(ssh-agent -k)"  >>/mnt/wd2tb/script/mpIIaconoff/log/mpIIaconoff_shlog.txt
